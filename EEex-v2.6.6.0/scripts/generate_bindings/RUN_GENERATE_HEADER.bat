...
python %script_path%^
 ...
 -aliasFiles=%core_in%/alias_v2.6.txt^
 ...
 -inFiles=NO_BINDINGS;NO_HARDCODED_BINDINGS:%core_in%/manual_types.txt,NO_BINDINGS;NO_HARDCODED_BINDINGS:%core_in%/manual_reimplementations_import.txt,NO_BINDINGS;NO_HARDCODED_BINDINGS:%core_in%/Baldur-v2.6.6.0.h,%core_in%/bindings.txt^
...
copy /Y .\out\Baldur_generated.h ..\..\headers\EEex-v2.6.6.0_generated
copy /Y .\out\Baldur_generated_internal_pointers.cpp ..\..\source\EEex-v2.6.6.0\generated
...
python %script_path%^
 ...
 -inFiles=%lua_in%/manual_types.txt,%core_in%/Baldur-v2.6.6.0.h^
 -noCustomTypes^
...
copy /Y .\out\Baldur_lua_generated.h ..\..\headers\EEex-v2.6.6.0_generated
