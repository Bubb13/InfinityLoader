...
copy /Y .\out\Baldur_generated.h ..\..\headers\LuaBindings-v2.6.6.0_generated\
copy /Y .\out\Baldur_generated_internal_pointers.cpp ..\..\source\LuaBindings-v2.6.6.0\generated
...
copy /Y .\out\Baldur_lua_generated.h ..\..\headers\LuaBindings-v2.6.6.0_generated\
