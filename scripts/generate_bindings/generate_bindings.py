...
primitives          = { "byte", "short", "ushort", "uint", "ptrdiff_t", "intptr_t", "uintptr_t", "size_t", "int", "__int8", "__int16", "__int32", "__int64", "int8_t", "uint8_t", "int16_t", "uint16_t", "int32_t", "uint32_t", "int64_t", "uint64_t", "long", "bool", "char", "float", "wchar_t", "double", "long double", "BOOL", "DWORD", "HRESULT", "INT", "LONG", "LPCSTR", "LRESULT", "UINT", "lua_Integer" }
handledPrimitives   = { "byte", "short", "ushort", "uint", "ptrdiff_t", "intptr_t", "uintptr_t", "size_t", "int", "__int8", "__int16", "__int32", "__int64", "int8_t", "uint8_t", "int16_t", "uint16_t", "int32_t", "uint32_t", "int64_t", "uint64_t", "long", "bool", "char", "float",            "double", "long double", "BOOL", "DWORD", "HRESULT", "INT", "LONG", "LPCSTR", "LRESULT", "UINT", "lua_Integer" }
primitiveNumbers    = { "byte", "short", "ushort", "uint", "ptrdiff_t", "intptr_t", "uintptr_t", "size_t", "int", "__int8", "__int16", "__int32", "__int64", "int8_t", "uint8_t", "int16_t", "uint16_t", "int32_t", "uint32_t", "int64_t", "uint64_t", "long",                 "float",            "double", "long double", "BOOL", "DWORD", "HRESULT", "INT", "LONG",           "LRESULT", "UINT", "lua_Integer" }
