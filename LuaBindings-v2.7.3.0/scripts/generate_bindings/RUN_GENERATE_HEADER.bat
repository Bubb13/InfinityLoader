...
python %PYTHON_OPTIONS% %script_path%^
 ...
 -dllName=LuaBindings-v2.7.3.0.dll^
...
copy /Y .\out\Baldur-v2.7.3.0_generated.h ..\..\headers\LuaBindings-v2.7.3.0_generated\
copy /Y .\out\Baldur-v2.7.3.0_generated_internal_pointers.cpp ..\..\source\LuaBindings-v2.7.3.0\Generated
...
copy /Y .\out\Baldur-v2.7.3.0_lua_generated.h ..\..\headers\LuaBindings-v2.7.3.0_generated\
