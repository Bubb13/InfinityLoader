...
//
void mapinheritance(lua_State* L, const char* name, const char* baseName) {
...
//static void original_tolua_open(lua_State* L) {
 ...
 */
EXPORT void tolua_endmodule(lua_State* L)
{
	lua_pop(L, 1);
}
...
// [ table ]
#if 1
//static void original_tolua_module(lua_State* L, const char* name, int hasvar) {
//	if (name) {
...
// Expects [ module ]
//static void original_tolua_cclass(lua_State* L, const char* lname, const char* name, const char* base, lua_CFunction col) {
 ...
 */
EXPORT void tolua_function(lua_State* L, const char* name, lua_CFunction func)
{
	lua_pushstring(L, name);
 ...
 */
EXPORT void tolua_constant(lua_State* L, const char* name, double value)
{
	lua_pushstring(L, name);
 ...
 */
EXPORT void tolua_variable(lua_State* L, const char* name, lua_CFunction get, lua_CFunction set)
{
	/* get func */
