...
EXPORT void tolua_error(lua_State* L, const char* msg, tolua_Error* err);
EXPORT void tolua_function(lua_State* L, const char* name, lua_CFunction func);
EXPORT void tolua_pushboolean(lua_State* L, int value);
EXPORT void tolua_pushnumber(lua_State* L, double value);
EXPORT void tolua_pushstring(lua_State* L, const char* value);
EXPORT const char* tolua_typename(lua_State* L, int lo);
