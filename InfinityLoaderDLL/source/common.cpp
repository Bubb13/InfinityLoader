...
instantiateBoundsExceeded(unsigned __int16)
instantiateBoundsExceeded(unsigned __int32)
instantiateBoundsExceeded(unsigned __int64)
instantiateBoundsExceeded(unsigned __int8)
